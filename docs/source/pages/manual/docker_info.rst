...
ここでは、i2b2実装のためのGitHubリポジトリ `i2b2-jp < https://github.com/yuakagi/i2b2-jp >`_ を利用します。

.. note::
      - i2b2は継続的に開発が進んでおり、バージョンアップに伴い大幅に内容が変わる可能性があります。当面の間、このマニュアルは2025年8月時点での最新の **i2b2 version 1.8.x** を対象とします。
